        ...
        <div className="content">
            ...
            <div className="row">
                ...
                <div className="card">
                    ...
                    <div className="mt-3">
                        <h6 className="text-uppercase">Target <span className="float-end">60%</span></h6>
                        <div className="progress progress-sm m-0">
                        <div className="progress-bar bg-blue" role="progressbar" aria-valuenow={60} aria-valuemin={0} aria-valuemax={100} style={{width: '60%'}}>
                ...
                <div className="card">
                    ...
                    <div className="mt-3">
                        <h6 className="text-uppercase">Target <span className="float-end">49%</span></h6>
                        <div className="progress progress-sm m-0">
                ...
                <div className="card">
                    ...
                    <div className="row">
                        ...
                        <div className="col-6">
                        <div className="text-end">
                            <h3 className="text-dark my-1">$<span data-plugin="counterup">8947</span></h3>
                            <p className="text-muted mb-1 text-truncate">Payouts</p>
                        </div>
                        </div>
                    </div>
                    <div className="mt-3">
                        <h6 className="text-uppercase">Target <span className="float-end">18%</span></h6>
                        <div className="progress progress-sm m-0">
                        <div className="progress-bar bg-warning" role="progressbar" aria-valuenow={18} aria-valuemin={0} aria-valuemax={100} style={{width: '18%'}}>
                ...
                <div className="card">
                    ...
                    <div className="row">
                        ...
                        <div className="col-6">
                        <div className="text-end">
                            <h3 className="text-dark my-1"><span data-plugin="counterup">178</span></h3>
                            <p className="text-muted mb-1 text-truncate">Available Stores</p>
                        </div>
                        </div>
                    </div>
                    <div className="mt-3">
                        <h6 className="text-uppercase">Target <span className="float-end">74%</span></h6>
                        <div className="progress progress-sm m-0">
            ...
            <div className="row">
                ...
                <div className="card">
                    ...
                    <div className="card-widgets">
                        <a href="javascript: void(0);" data-bs-toggle="reload"><i className="mdi mdi-refresh" /></a>
                        <a data-bs-toggle="collapse" href="dashboard-2.html#cardCollpase1" role="button" aria-expanded="false" aria-controls="cardCollpase1"><i className="mdi mdi-minus" /></a>
                        <a href="javascript: void(0);" data-bs-toggle="remove"><i className="mdi mdi-close" /></a>
                    </div>
                    ...
                    <div id="cardCollpase1" className="collapse show">
                        ...
                        <div className="row mt-3">
                            ...
                            <h4><i className="fe-arrow-down text-danger me-1" />$9.8k</h4>
                            </div>
                        </div> {/* end row */}
                        </div>
                    </div> {/* collapsed end */}
                ...
                <div className="card">
                    ...
                    <div className="card-widgets">
                        <a href="javascript: void(0);" data-bs-toggle="reload"><i className="mdi mdi-refresh" /></a>
                        <a data-bs-toggle="collapse" href="dashboard-2.html#cardCollpase2" role="button" aria-expanded="false" aria-controls="cardCollpase2"><i className="mdi mdi-minus" /></a>
                        <a href="javascript: void(0);" data-bs-toggle="remove"><i className="mdi mdi-close" /></a>
                    </div>
                    ...
                    <div id="cardCollpase2" className="collapse show">
                        ...
                        <div className="row mt-3">
                            <div className="col-4">
                            <p className="text-muted font-15 mb-1 text-truncate">Target</p>
                            <h4><i className="fe-arrow-up text-success me-1" />641</h4>
                            </div>
                            <div className="col-4">
                            <p className="text-muted font-15 mb-1 text-truncate">Last week</p>
                            <h4><i className="fe-arrow-down text-danger me-1" />234</h4>
                            </div>
                            <div className="col-4">
                            <p className="text-muted font-15 mb-1 text-truncate">Last Month</p>
                            <h4><i className="fe-arrow-up text-success me-1" />3201</h4>
                            </div>
                        </div> {/* end row */}
                        </div>
                    </div> {/* collapsed end */}
                ...
                <div className="card">
                    ...
                    <div className="card-widgets">
                        <a href="javascript: void(0);" data-bs-toggle="reload"><i className="mdi mdi-refresh" /></a>
                        <a data-bs-toggle="collapse" href="dashboard-2.html#cardCollpase3" role="button" aria-expanded="false" aria-controls="cardCollpase3"><i className="mdi mdi-minus" /></a>
                        <a href="javascript: void(0);" data-bs-toggle="remove"><i className="mdi mdi-close" /></a>
                    </div>
                    <h4 className="header-title mb-0">Total Users</h4>
                    <div id="cardCollpase3" className="collapse show">
                        <div className="text-center pt-3">
                        <div id="total-users" data-colors="#00acc1,#4b88e4,#e3eaef,#fd7e14" />
                        <div className="row mt-3">
                            <div className="col-4">
                            <p className="text-muted font-15 mb-1 text-truncate">Target</p>
                            <h4><i className="fe-arrow-down text-danger me-1" />18k</h4>
                            </div>
                            <div className="col-4">
                            <p className="text-muted font-15 mb-1 text-truncate">Last week</p>
                            <h4><i className="fe-arrow-up text-success me-1" />3.25k</h4>
                            </div>
                            <div className="col-4">
                            <p className="text-muted font-15 mb-1 text-truncate">Last Month</p>
                            <h4><i className="fe-arrow-up text-success me-1" />28k</h4>
                            </div>
                        </div> {/* end row */}
                        </div>
                    </div> {/* collapsed end */}
            ...
            <div className="row">
                ...
                <div className="card">
                    ...
                    <div className="card-widgets">
                        <a href="javascript: void(0);" data-bs-toggle="reload"><i className="mdi mdi-refresh" /></a>
                        <a data-bs-toggle="collapse" href="dashboard-2.html#cardCollpase4" role="button" aria-expanded="false" aria-controls="cardCollpase4"><i className="mdi mdi-minus" /></a>
                        <a href="javascript: void(0);" data-bs-toggle="remove"><i className="mdi mdi-close" /></a>
                    </div>
                ...
                <div className="card">
                    ...
                    <div className="card-widgets">
                        <a href="javascript: void(0);" data-bs-toggle="reload"><i className="mdi mdi-refresh" /></a>
                        <a data-bs-toggle="collapse" href="dashboard-2.html#cardCollpase5" role="button" aria-expanded="false" aria-controls="cardCollpase5"><i className="mdi mdi-minus" /></a>
                        <a href="javascript: void(0);" data-bs-toggle="remove"><i className="mdi mdi-close" /></a>
                    </div>
