        ...
        <div className="navbar-custom">
            <div className="topbar">
                ...
                <div className="dropdown d-none d-xl-block">
                    <a className="nav-link dropdown-toggle waves-effect waves-light" data-bs-toggle="dropdown" href="index.html#" role="button" aria-haspopup="false" aria-expanded="false">
                    Create New
                ...
                <li className="app-search dropdown me-3 d-none d-lg-block">
                    ...
                    <span className="fe-search search-icon font-16" />
                    </form>
                ...
                <li className="d-none d-md-inline-block">
                    <a className="nav-link waves-effect waves-light" href="index.html" data-toggle="fullscreen">
                    <i className="fe-maximize font-22" />
                    </a>
                </li>
                {/* Search Dropdown (for Mobile/Tablet) */}
                <li className="dropdown d-lg-none">
                    <a className="nav-link dropdown-toggle waves-effect waves-light arrow-none" data-bs-toggle="dropdown" href="index.html#" role="button" aria-haspopup="false" aria-expanded="false">
                ...
                <li className="dropdown">
                    <a className="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="index.html#" role="button" aria-haspopup="false" aria-expanded="false">
                ...
                <li>
                    <a className="nav-link waves-effect waves-light" data-bs-toggle="offcanvas" href="index.html#theme-settings-offcanvas">
